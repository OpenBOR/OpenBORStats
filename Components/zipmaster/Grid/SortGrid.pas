...
type
  ...
  public
    ...
    function  FindFirst( const aStr: String; var sCol, sRow: LongInt; eCol, eRow: LongInt ): Boolean; virtual; //RCV02
    function  FindNext( var aCol, aRow: LongInt ): Boolean; virtual; //RCV02
...
{$IFDEF VERD5-}
// version 5 or less
function TryStrToFloat(s: string; v: extended): boolean;
function TryStrToInt(s: string; v: integer): boolean;
function TryStrToTime(s: string; v: TDateTime): boolean;
function TryStrToDateTime(s: string; v: TDateTime): boolean;
{$endif}
