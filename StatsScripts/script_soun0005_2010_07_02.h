...
#include "data/scripts/com/soun0009.h"      //Sound player.
#include "data/scripts/com/rnd0001.h"       //Random number generator.
#include "data/scripts/com/path0001.h"      //Get file path of entity.
